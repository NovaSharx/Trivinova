        ...
        <Mui.Container>
            ...
            <Mui.Paper elevation={5} sx={{ padding: 5, display: 'flex', justifyContent: 'center' }}>
                <Mui.Stack spacing={3} direction='row'>
                    ...
                    <Mui.Button sx={{ width: 300, height: 300, background: 'url(./pexels-dmitry-demidov-3852577.jpg)', backgroundColor: 'grey', backgroundBlendMode: 'multiply' }} variant='outlined'>
